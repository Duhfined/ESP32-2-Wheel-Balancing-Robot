...
* **2 x 18650 Batteries:** Provides roughly 7.4V enough to be stepped down but also stable enough to power the DC motors. The whole circuit is connected in parallel which means both paths draw 7.4V and their own current.
